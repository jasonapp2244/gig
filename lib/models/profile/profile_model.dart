class ProfileModel {
  ...
  factory ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    return ProfileModel(
      ...
      address: json['address_one'] ?? json['location'],
      profileImagePath:
          json['profile_image'] ?? json['avatar'] ?? json['image_url'],
      pdfFilePath: json['cv'] ?? json['resume'] ?? json['cv_url'],
      pdfFileName:
          json['cv_filename'] ?? json['resume_name'] ?? json['cv_name'],
      email: json['email'],
      skills: skillsList,
    );
  }
  ...
  Map<String, String> toFormData() {
    ...
    if (address != null) formData['address_one'] = address!;
  ...
  @override
  String toString() {
    return 'ProfileModel(name: $name, phoneNumber: $phoneNumber, address_one: $address, skills: $skills, pdfFileName: $pdfFileName,email:$email)';
  }
}
