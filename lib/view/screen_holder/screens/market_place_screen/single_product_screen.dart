...
class _SingleProductScreen extends State<SingleProductScreen> {
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            right: 10,
                            bottom: 10,
                            child: Icon(Icons.shopping_cart_checkout, color: AppColor.primeColor),
                          ),
                        ],
                      ),
                    ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text("| 128 Reviews", style: TextStyle(color: Colors.white70, fontSize: 13)),
                            ],
                          ),
                          SizedBox(height: 10),
                          Text("Send seller a message", style: TextStyle(color: Colors.white, fontSize: 16)),
                          SizedBox(height: 8),
                          Container(
                            decoration: BoxDecoration(
                            ...
                            child: Row(
                              children: [
                                Icon(LucideIcons.messageSquare, color: Colors.grey),
                                SizedBox(width: 8),
                                Expanded(
                                  child: TextField(
                          ...
                          TextButton(
                            onPressed: () {},
                            child: Text("View more", style: TextStyle(color: Colors.redAccent)),
                          ),
                          ...
                          buildAccordion("Additional information", infoExpanded, () {
  ...
  Widget buildAccordion(String title, bool expanded, VoidCallback onTap, String content) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ListTile(
